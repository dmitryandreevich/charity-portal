/**
 * Created by mmarkovich on 12.05.2018.
 */


$(document).ready(function () {

    /** Добавление слайдера Организации, нуждающиеся в помощи **/
    $('.main-slider_content').slick({
        infinite: true,
        slidesToShow: 3,
        slidesToScroll: 1,
        centerPadding: '60px',
    ...
    /** Добавление слайдера Реализованные потребности **/
    $('.completed-slider_content').slick({
        infinite: true,
        slidesToShow: 4,
        slidesToScroll: 1,
        responsive: [
    ...
    $(window).scroll(function(){
        $('.header').toggleClass('header-has-background', $(this).scrollTop() > 100);
    });
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
        zoom: 6,
        center: new google.maps.LatLng(55.4507,37.3656),
