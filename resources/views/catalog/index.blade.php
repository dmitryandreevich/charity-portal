            ...
            <div class="container">
                ...
                <ul class="headroom_list row">
                    <li class="headroom_item big">
                        <select placeholder="Город" name="city" class="headroom_city sources custom-select big sort-select filter_city">
                            <option>Омск</option>
                    ...
                    <li class="headroom_item big">
                        <select placeholder="Тип организации" name="type_consumer" class="type sources custom-select big sort-select filter-type_org">
                    ...
                    <li class="headroom_item big">
                        <select placeholder="Вид потребностей" name="view" class="view sources custom-select big sort-select filter-type_need">
                    ...
                    <li class="headroom_item select-small">
                        <select placeholder="Сортировка" name="sort" class="sources custom-select big sort-select sort-type_catalog_all">
